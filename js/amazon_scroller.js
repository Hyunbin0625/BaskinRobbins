...
*/ 
            ...
            $(function() {
				$("#amazon_scroller1").amazon_scroller({
                    ...
                    scroller_time_interval: '1500',
                    scroller_window_background_color: "none",
                    scroller_window_padding: '0',
                    scroller_border_size: '0',
                    scroller_border_color: '#9C6',
                    scroller_images_width: '381',
                    scroller_images_height: '465',
...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        var g=p&&p.scroller_time_interval?p.scroller_time_interval:"1500";
        ...
        function s_s_nav(a,d){
            ...
            a.children("li").css("width","15px");
            a.children("li").css("height","30px");
